...
def main():
    ...
    # text_model_config_file = Path(__file__).parent.parent / f"clip/model_configs/{args.text_model.replace('/', '-')}_edited.json"
    ...
    data = get_data(args, unpair=False, epoch_id=0, max_txt_length=args.context_length)
    ...
    model.module.logit_scale.data.fill_(2.659260036932778)
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        if epoch + 1 < args.max_epochs:
            data = get_data(args, unpair=False, epoch_id=epoch + 1, max_txt_length=args.context_length)
